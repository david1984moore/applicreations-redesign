...
export const en: Dictionary = {
  ...
  meta: {
    ...
    redesignTitle: 'Introspect Redesign — Applicreations',
    redesignDescription:
      'A short questionnaire about your current website so we can design a preview of the redesign.',
  ...
  about: {
    ...
    p1: 'I filled a lot of sketchbooks growing up — pencil, ink, charcoal, watercolor. Later, as a chef, I found a new canvas in flavor and presentation.',
    p2: "Teaching myself web design and software in 2021, I saw how often small businesses ended up with generic, templated sites that didn't reflect who they were. I wanted to build something different — work shaped entirely around each client's needs. Applicreations was the result, launched in 2025.",
    p3: "Template builders are fast and increasingly automated, but they can leave you feeling like a number. Applicreations doesn't work that way — every project is original, built around your business and what makes it distinct. I help plant unique digital roots, and I'd love to help you plant yours.",
  },
  contact: {
    eyebrow: 'Contact',
  ...
  pricingPage: {
    ...
    goingLiveStep2CancelBuildHeading: 'Website build',
    goingLiveStep2BulletCancelBuild:
      'The preview / demo site is free. The first payment is a non-refundable down payment. If you cancel after your website build has started, all data is transferred to you in its current state.',
  ...
  introspectUi: {
    ...
    welcomeContinue: 'Let’s learn about your project',
    redesignWelcomeContinue: 'Let’s look at your current site',
    redesignWelcomeHeading: 'Welcome — let’s look at your current site',
    getStarted: 'Start',
    // Step 1
    ...
    step2SubtitleRedesign:
      'Even if the current site already says this — say it in your own words.',
    ...
    locationCityPlaceholder: 'City or town',
    locationStateLabel: 'State',
    locationStatePlaceholder: 'State or region',
    locationCountryLabel: 'Country',
    locationNoMatches: 'No matches',
    // Step 3
    step3Title: 'Your online presence today',
    step3Subtitle: "It's fine if you don't have a website yet.",
    step3TitleRedesign: 'Your current website',
    step3SubtitleRedesign: 'We’ll start from the live site, then decide what to keep.',
    ...
    websiteUrlLabelHasSite: 'Link to your current website',
    websiteUrlLabelRedesign: 'Link to the site you want redesigned',
    websiteUrlRequired: 'Please enter the address of the site you want redesigned',
    websiteUrlPlaceholder: 'yourwebsite.com',
    ...
    step4SubtitleRedesign: 'We’ll also look at what’s already on your site.',
    ...
    keepChangeTitle: 'What should we keep — and what needs to change?',
    keepChangeSubtitle: 'Pick all that apply. We can refine this when we review your site.',
    keepHeading: 'What should we keep?',
    changeHeading: 'What needs to change the most?',
    keepItemsError: 'Please pick at least one thing to keep — or start fresh',
    changePrioritiesError: 'Please pick at least one thing that needs to change',
    keepChangeNotesLabel: 'Anything specific about the current site we should know?',
    keepChangeNotesPlaceholder: 'Optional — pages that matter, things that are broken, or details we should notice…',
    // Step 5
    step5Title: 'What should people be able to do on your website?',
    step5Hint: 'Pick all that apply — as many as you like.',
    step5TitleRedesign: 'On the new site, what should people be able to do?',
    step5HintRedesign: 'Include things your current site already does, plus anything new.',
    visitorActionsError: 'Please pick at least one thing people should be able to do',
    // Step 6
    step6Title: 'How developed should it be?',
    step6Subtitle: 'Pick the closest fit. We can refine this when we review your answers.',
    step6SubtitleRedesign: 'Think about the new site, not how many pages you have now.',
    ...
    keepCurrentLook: 'Keep the look of my current site',
    ...
    step9PlaceholderRedesign:
      'Optional — must-haves from the current site, pages that matter, or anything we should not miss…',
    // Buttons
    continue: 'Continue',
    ...
    reviewCurrentWebsite: 'Current website',
    reviewAlreadyOnline: 'Already online?',
    reviewWebsite: 'Website',
    reviewKeepChange: 'Keep vs change',
    reviewKeep: 'Keep',
    reviewChange: 'Change',
    reviewCurrentSiteNotes: 'Notes about the current site',
    ...
    successHeadingRest: '— we received your Introspect answers',
    successHeadingRedesign: 'Thanks — we received your redesign answers',
    successHeadingRestRedesign: '— we received your redesign answers',
    successNextHeading: 'What happens next…',
    successNext1: 'In two days or less - a link to the demo site is sent by email.',
    successNext1Redesign:
      'In two days or less - a link to the redesigned demo is sent by email.',
    successNext2:
      "When you receive the demo site by email, you'll have 24 hours to try it out.",
    successClosing: 'Thank you for using Introspect.',
    successClosingRedesign: 'Thank you for using Introspect.',
    // Errors
    errorGeneric: 'Something went wrong. Please try again.',
  ...
  introspectValidation: {
    ...
    locationCityEmpty: 'Please enter a city or town',
    locationCityShort: 'Please enter a real city or town',
    locationStateEmpty: 'Please enter a state or region',
    locationCountryEmpty: 'Please choose a country',
  ...
  introspectOptions: {
    ...
    visitorActions: {
      'call-you': 'Call you',
      'email-you': 'Email you',
      'see-hours': 'See your hours',
      'find-you': 'Find where you are',
      'get-directions': 'Get directions',
      'see-photos': 'See photos',
      'read-about-you': 'Read about you',
      'see-a-menu': 'See a menu',
      'see-prices': 'See prices',
      'see-what-you-offer': 'See what you offer',
      'see-events': 'See upcoming events',
      'see-a-calendar': 'See a calendar',
      'browse-a-gallery': 'Browse a gallery',
      'watch-a-video': 'Watch a video',
      listen: 'Listen to music or audio',
      'read-updates': 'Read news or updates',
      'read-stories': 'Read stories',
      'meet-the-people': 'Meet the people',
      'see-a-portfolio': 'See a portfolio',
      'download-a-file': 'Download a file',
      'ask-a-question': 'Ask a question',
      'fill-out-a-form': 'Fill out a form',
      'join-email-list': 'Join an email list',
      ...
      chat: 'Chat with you',
      'sign-up-for-a-class': 'Sign up for a class',
    },
    designFeels: {
    ...
    keepItems: {
      ...
      colors: 'My colors',
      photos: 'My photos',
      words: 'The words / how I describe the business',
      pages: 'The same pages (Home, About, and the like)',
      contact: 'How people reach me',
      'start-fresh': 'Nothing — start fresh',
    },
    changePriorities: {
      'looks-old': 'It looks old or unlike my business',
      'hard-on-phone': 'Hard to use on a phone',
      'hard-to-find': "People can't find what they need",
      'easier-to-update': 'I want it easier to update',
      'new-things': "I want new things it can't do now",
      'words-off': "The words don't sound like us",
      'hard-to-search': "People can't find us when they search",
      'slow-or-broken': "It's slow or things are broken",
    },
    recommend: {
    ...
    emailLabels: {
      ...
      keepCurrentLook: 'Keep the look of my current site',
      keepItems: 'What to keep',
      changePriorities: 'What needs to change',
      currentSiteNotes: 'Notes about the current site',
      flow: 'Flow',
  ...
  api: {
    ...
    introspect: {
      ...
      clientEmailIntro:
        'We’re building a demo site from your answers. Watch your inbox and spam folder for a link to preview it. A copy of everything you shared is below.',
      clientEmailSubjectRedesign: 'We received your redesign answers',
      clientEmailTitleRedesign: 'Thanks — we got your redesign Introspect',
      clientEmailIntroRedesign:
        'We’re building a demo of your new site from these answers. Watch your inbox and spam folder for a link to preview it. A copy of everything you shared is below.',
      ...
      clientEmailSectionKeepChange: 'Keep vs change',
      ...
      ownerEmailSubjectRedesign: 'Introspect redesign: {business} — {plan}',
      ownerEmailTitleRedesign: 'New Introspect redesign submission',
      ownerEmailIntroRedesign: 'A new redesign questionnaire came in for {business}.',
      websiteUrlRequired: 'Please enter the address of the site you want redesigned.',
      keepChangeRequired: 'Please tell us what to keep and what needs to change.',
    },
    pricingSelection: {
      invalidBody: 'Invalid request body.',
      emailInvalid: 'Please enter a valid email.',
